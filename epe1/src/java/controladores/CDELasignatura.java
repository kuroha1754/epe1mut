 ...
 * @author Leona
 */
@WebServlet(name = "CDELasignatura", urlPatterns = {"/CDELasignatura"})
public class CDELasignatura extends HttpServlet {
...
"    <!--NAVbar fin-->");
            out.println("<body>");
            out.println("<center><h3>"+ejecutar.delasignatura(seccion)+"</h3></center>");
            out.println("</body>");
            out.println("</html>");
        }
    }
