 ...
 * @author Leona
 */
@WebServlet(name = "CDELestudiante", urlPatterns = {"/CDELestudiante"})
public class CDELestudiante extends HttpServlet {
...
"    <!--NAVbar fin-->");
            out.println("<body>");
            out.println("<center><h3>"+ejecutar.delestudiante(rut)+"</h3></center>");
            out.println("</body>");
            out.println("</html>");
        }
    }
