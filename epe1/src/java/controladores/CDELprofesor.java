 ...
 * @author Leona
 */
@WebServlet(name = "CDELprofesor", urlPatterns = {"/CDELprofesor"})
public class CDELprofesor extends HttpServlet {
...
"    <!--NAVbar fin-->");
            out.println("<body>");
            out.println("<center><h3>"+ejecutar.delprofesor(rut)+"</h3></center>");
            out.println("</body>");
            out.println("</html>");
        }
    }
