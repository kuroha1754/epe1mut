 ...
 * @author Leona
 */
@WebServlet(name = "CINasignatura", urlPatterns = {"/CINasignatura"})
public class CINasignatura extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Ingreso de Datos Exitoso</title>");
...
"    <!--NAVbar fin-->");
            out.println("<body>");
            out.println("<center><h3>"+ejecutar.inasignatura(seccion, sala, asignatura, departamento)+"</h3></center>");
            out.println("</body>");
            out.println("</html>");
        }
    }
