 ...
 * @author Leona
 */
@WebServlet(name = "CINestudiante", urlPatterns = {"/CINestudiante"})
public class CINestudiante extends HttpServlet {
...
"    <!--NAVbar fin-->");
            out.println("<body>");
            out.println("<center><h3>"+ejecutar.inestudiante(rut, nombre, apoderado, seccion)+"</h3></center>");
            out.println("</body>");
            out.println("</html>");
        }
    }
