 ...
 * @author Leona
 */
@WebServlet(name = "CINprofesor", urlPatterns = {"/CINprofesor"})
public class CINprofesor extends HttpServlet {
...
"    <!--NAVbar fin-->");
            out.println("<body>");
            out.println("<center><h3>"+ejecutar.inprofesor(rut, nombre, seccion, departamento)+"</h3></center>");
            out.println("</body>");
            out.println("</html>");
        }
    }
