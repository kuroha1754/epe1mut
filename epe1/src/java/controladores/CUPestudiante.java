 ...
 * @author Leona
 */
@WebServlet(name = "CUPestudiante", urlPatterns = {"/CUPestudiante"})
public class CUPestudiante extends HttpServlet {
...
"    <!--NAVbar fin-->");
            out.println("<body>");
            out.println("<center><h3>"+ejecutar.upestudiante(rut, nombre, apoderado, seccion)+"</h3></center>");
            out.println("</body>");
            out.println("</html>");
        }
    }
