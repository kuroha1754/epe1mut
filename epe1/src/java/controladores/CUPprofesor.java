 ...
 * @author Leona
 */
@WebServlet(name = "CUPprofesor", urlPatterns = {"/CUPprofesor"})
public class CUPprofesor extends HttpServlet {
...
"    <!--NAVbar fin-->");
            out.println("<body>");
            out.println("<center><h3>"+ejecutar.upprofesor(rut, nombre, seccion, departamento)+"</h3></center>");
            out.println("</body>");
            out.println("</html>");
        }
    }
