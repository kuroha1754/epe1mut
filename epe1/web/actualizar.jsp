   ...
   <ul class="navbar-nav">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
               <hr>
                <center><h1 class="page-header">Seleccione lo que quiera Actualizar
                    <small></small>
                    <hr>
                </h1></center>
            </div>
        ...
        <!-- Portfolio Item Row -->      
           <div class="text-center">
               ...
               <a href="UPasignatura.jsp" class="btn btn-primary btn-lg btn-block">Asignatura</a>
               <a href="UPprofesor.jsp" class="btn btn-danger btn-lg btn-block">Profesor</a>
               <a href="UPestudiante.jsp" class="btn btn-light btn-lg btn-block">Estudiante</a>
