   ...
   <ul class="navbar-nav">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
               <hr>
                <center><h1 class="page-header">Seleccione el Ingreso
                    <small></small>
                    <hr>
                </h1></center>
            </div>
        ...
        <!-- Portfolio Item Row -->
           ...
           <div class="text-center">
               ...
               <a href="INasignatura.jsp" class="btn btn-primary btn-lg btn-block">Asignatura</a>
               <a href="INprofesor.jsp" class="btn btn-danger btn-lg btn-block">Profesor</a>
               <a href="INestudiante.jsp" class="btn btn-light btn-lg btn-block">Estudiante</a>
