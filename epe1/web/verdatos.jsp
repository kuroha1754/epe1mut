   ...
   <ul class="navbar-nav">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
               <hr>
                <center><h1 class="page-header">Seleccione los datos que quiera ver
                    <small></small>
                    <hr>
                </h1></center>
            </div>
        ...
        <!-- Portfolio Item Row -->      
           <div class="text-center">
               ...
               <a href="OUTasignatura.jsp" class="btn btn-primary btn-lg btn-block" onclick="alert('Conexion realizada con exito')">Asignatura</a>
               <a href="OUTprofesor.jsp" class="btn btn-danger btn-lg btn-block" onclick="alert('Conexion realizada con exito')">Profesor</a>
               <a href="OUTestudiante.jsp" class="btn btn-light btn-lg btn-block" onclick="alert('Conexion realizada con exito')">Estudiante</a>
